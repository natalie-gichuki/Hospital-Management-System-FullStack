...
//         .typeError('Head doctor ID must be a number')
//         .required('Head doctor ID is required'),
//     }),
...
//         <h2 className="text-2xl font-bold mb-4">Register Department</h2>
...
//                 <th className="border px-3 py-2 text-left">Head Doctor ID</th>
...
//                   <td className="border px-3 py-2">{dept.headdoctor?.name ? `Dr. ${dept.headdoctor.name}` : 'Not Assigned'}</td>
